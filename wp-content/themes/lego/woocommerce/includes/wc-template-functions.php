...
function wc_replace_policy_page_link_placeholders( $text ) {
	...
	// $terms_link      = $terms_page_id ? '<a data-fancybox href="' . esc_url( get_permalink( $terms_page_id ) ) . '" ..class="woocommerce-terms-and-conditions-link" target="_blank">' . __( 'terms and conditions', 'woocommerce' ) . '</a>' : __( 'terms and conditions', 'woocommerce' );

	$terms_link      = $terms_page_id ? '<a href="' . the_field('oferta_terms', 534) . '" class="woocommerce-terms-and-conditions-link" target="_blank">' . __( 'terms and conditions', 'woocommerce' ) . '</a>' : __( 'terms and conditions', 'woocommerce' );
